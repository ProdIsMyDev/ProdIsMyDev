...
export const meta = {
    ...
    date: '2022-11-18',
    title: 'Software Development Should Be Fun',
    description:
        'Software development has become a great way to make some money while having an overall (in most cases) relaxing job. But do you still enjoy what you do?'
}
